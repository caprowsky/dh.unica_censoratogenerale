...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'warning',
  'file' => '/var/www/html/censoratogenerale/log/qubit_prod.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => '/var/www/html/censoratogenerale/cache/qubit/prod/template',
  'lifetime' => 86400,
  'prefix' => '/var/www/html/censoratogenerale/apps/qubit/template',
));
